...
console.log(`The spacecraft ${spaceShuttle.name} will arrive to Mars in ${spaceShuttle.getDaysToLocation(kilometersToMars)} days.`);
console.log(`The spacecraft ${spaceShuttle.name} will arrive to the Moon in ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days.`);
